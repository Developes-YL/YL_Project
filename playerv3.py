...
class Player(pygame.sprite.Sprite):
    ...
    def rotate(self):
        ...
        self.images = [pygame.transform.rotate(pygame.transform.scale(TANK_PLAYER_1[0], (95, 95)), 90 * self.direction),
                       pygame.transform.rotate(pygame.transform.scale(TANK_PLAYER_1[1], (95, 95)), 90 * self.direction)]
